...
These slides provide an intro to Git and using Git with R
...
# The Git Workflow
# What's the Payoff? 
# Using R Studio and GitHub
#Make a repo on GitHub
* Go to https://github.com and make sure you are logged in
* Click green "New repository" button
* Fill this in: 
    + Repository name: `volcanoRepo` (whatever you want!)
    + Description: "Volcano repo- for learning!" (some text is good for the README)
    + Public
